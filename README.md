...
3. Fusion results of RGB, YIQ, HSV and FCDFusion methods will be saved in "/output/method_name".
...
1. Put visible images and corresponding fused images into "/input/visible" and "/output/method_name", respectively. The two paired images should be in the same shape and has the same name like "xxx.jpg". You can change codes in "color_deviation.py" to change the available image type.
